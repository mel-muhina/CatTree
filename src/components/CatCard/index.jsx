...
export default function CatCard({ cat }) {
  ...
  function starRating() {
    if (cat.breeds[0]?.adaptability === 1) {
      console.log("★");
    }
  }
      ...
      <div className="cat-card" key={cat.id}>
        ...
        <div className="cat-card-text">
          ...
          <ul>
            <li>
              {" "}
              <p>Adaptability: {cat.breeds[0]?.adaptability}/5</p>
            </li>
            <li>
              {" "}
              <p>Affectionate: {cat.breeds[0]?.affection_level}/5</p>
            </li>
            <li>
              {" "}
              <p>Dog Friendly: {cat.breeds[0]?.dog_friendly}/5</p>
            </li>
            <li>
              {" "}
              <p>Energy Level: {cat.breeds[0]?.energy_level}/5</p>
            </li>
            <li>
              {" "}
              <p>Hypoallergenic: {cat.breeds[0]?.hypoallergenic}/5</p>
            </li>
            <li>
              {" "}
              <p>Intelligence: {cat.breeds[0]?.intelligence}/5</p>
            </li>
          </ul>
